...
*   [Buildfile functions](#functions)
    ...
    *   [string_hash: Calculates a hash of a string.](#func_string_hash)
...
```
  ...
  `string_hash` returns a hash of the argument.  The hash is computed by first
  calculating an MD5 hash of the argument, and then returning the first 8
  characters of the lowercase-ASCII, hexadecimal encoding of the MD5 hash.
