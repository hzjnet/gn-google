...
cflags =
cflags_cc =
cc_module_name = //things$:c(//toolchain$:withmodules)
module_deps = -fmodule-map-file=../../stuff/b.modulemap -fmodule-file=//stuff:b(//toolchain:default)=obj/stuff/libb.b.pcm -fmodule-map-file=../../stuff/c.modulemap -fmodule-file=//things:c(//toolchain:withmodules)=obj/stuff/libc.c.pcm -fmodule-map-file=../../blah/a.modulemap -fmodule-file=blah_a=obj/blah/liba.a.pcm
...
TEST_F(NinjaCBinaryTargetWriterTest, ModuleMapGeneration) {
  ...
  const char expected_modulemap[] =
      "module \"//foo:bar(//toolchain:default)\" {\n"
  ...
  const char expected_modulemap_no_public[] =
      "module \"//foo:no_public(//toolchain:default)\" {\n"
