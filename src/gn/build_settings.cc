...
BuildSettings::BuildSettings() : python_path_is_relative_to_build_dir_(false) {}
...
BuildSettings::BuildSettings(const BuildSettings& other)
    : dotfile_name_(other.dotfile_name_),
      ...
      python_path_is_relative_to_build_dir_(other.python_path_is_relative_to_build_dir_),
