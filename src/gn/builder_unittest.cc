...
TEST_F(BuilderTest, RecursiveShouldGenerateWithValidations) {
  ...
  std::vector<const BuilderRecord*> expected_c;
  expected_c.push_back(c_record);
  ...
  std::vector<const BuilderRecord*> expected_final;
  expected_final.push_back(c_record);
  expected_final.push_back(e_record);
  expected_final.push_back(b_record);
  expected_final.push_back(a_record);
